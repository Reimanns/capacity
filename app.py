...
# ------- Your sample dataset (Python dict) -------
BASE_DATA = {
  "projects": [
    {
      "number": "P7657", "customer": "Kaiser", "aircraftModel": "B737", "scope": "Starlink",
      "induction": "2025-11-15T00:00:00", "delivery": "2025-11-25T00:00:00",
      "Maintenance": 93.57, "Structures": 240.61, "Avionics": 294.07, "Inspection": 120.3,
      "Interiors": 494.58, "Engineering": 80.2, "Cabinet": 0, "Upholstery": 0, "Finish": 13.37
    },
    {
      "number": "P7611", "customer": "Alpha Star", "aircraftModel": None, "scope": None,
      "induction": "2025-10-20T00:00:00", "delivery": "2025-12-04T00:00:00",
      "Maintenance": 2432.23, "Structures": 1252.97, "Avionics": 737.04, "Inspection": 1474.08,
      "Interiors": 1474.08, "Engineering": 0.0, "Cabinet": 0, "Upholstery": 0, "Finish": 0.0
    },
    {
      "number": "P7645", "customer": "Kaiser", "aircraftModel": "B737", "scope": "Starlink",
      "induction": "2025-11-30T00:00:00", "delivery": "2025-12-10T00:00:00",
      "Maintenance": 93.57, "Structures": 240.61, "Avionics": 294.07, "Inspection": 120.3,
      "Interiors": 494.58, "Engineering": 80.2, "Cabinet": 0, "Upholstery": 0, "Finish": 13.37
    },
    {
      "number": "P7426", "customer": "Celestial", "aircraftModel": "B757",
      "scope": "Post Maintenance Discrepancies",
      "induction": "2026-01-05T00:00:00", "delivery": "2026-01-15T00:00:00",
      "Maintenance": 0.0, "Structures": 0.0, "Avionics": 0.0, "Inspection": 0.0,
      "Interiors": 0.0, "Engineering": 0.0, "Cabinet": 0, "Upholstery": 0, "Finish": 0.0
    },
    {
      "number": "P7548", "customer": "Ty Air", "aircraftModel": "B737", "scope": "CMS Issues",
      "induction": "2025-10-20T00:00:00", "delivery": "2025-10-30T00:00:00",
      "Maintenance": 0.0, "Structures": 0.0, "Avionics": 0.0, "Inspection": 0.0,
      "Interiors": 0.0, "Engineering": 0.0, "Cabinet": 0, "Upholstery": 0, "Finish": 0.0
    },
    {
      "number": "P7706", "customer": "Valkyrie", "aircraftModel": "B737-MAX",
      "scope": "Starlink, Mods",
      "induction": "2025-10-31T00:00:00", "delivery": "2025-12-09T00:00:00",
      "Maintenance": 102.75, "Structures": 328.8, "Avionics": 411.0, "Inspection": 164.4,
      "Interiors": 945.3, "Engineering": 82.2, "Cabinet": 0, "Upholstery": 0, "Finish": 20.55
    },
    {
      "number": "P7685", "customer": "Sands", "aircraftModel": "B737-700", "scope": "Starlink",
      "induction": "2025-11-03T00:00:00", "delivery": "2025-11-17T00:00:00",
      "Maintenance": 105.44, "Structures": 224.06, "Avionics": 303.14, "Inspection": 118.62,
      "Interiors": 474.48, "Engineering": 79.08, "Cabinet": 0, "Upholstery": 0, "Finish": 13.18
    }
  ],
  "potential": [
    {
      "number": "P7661", "customer": "Sands", "aircraftModel": "A340-500", "scope": "C Check",
      "induction": "2026-01-29T00:00:00", "delivery": "2026-02-28T00:00:00",
      "Maintenance": 2629.44, "Structures": 1709.14, "Avionics": 723.1, "Inspection": 1248.98,
      "Interiors": 262.94, "Engineering": 0, "Cabinet": 0, "Upholstery": 0, "Finish": 0
    },
    {
      "number": "P7669", "customer": "Sands", "aircraftModel": "A319-133", "scope": "C Check",
      "induction": "2025-12-08T00:00:00", "delivery": "2026-01-28T00:00:00",
      "Maintenance": 2029.67, "Structures": 984.08, "Avionics": 535.55, "Inspection": 675.56,
      "Interiors": 1906.66, "Engineering": 0, "Cabinet": 0, "Upholstery": 0, "Finish": 0
    },
    {
      "number": None, "customer": "Sands", "aircraftModel": "B767-300", "scope": "C Check",
      "induction": "2026-09-15T00:00:00", "delivery": "2026-12-04T00:00:00",
      "Maintenance": 0.0, "Structures": 0.0, "Avionics": 0.0, "Inspection": 0.0,
      "Interiors": 0.0, "Engineering": 0, "Cabinet": 0, "Upholstery": 0, "Finish": 0
    },
    {
      "number": "P7686", "customer": "Polaris", "aircraftModel": "B777", "scope": "1A & 3A Mx Checks",
      "induction": "2025-12-01T00:00:00", "delivery": "2025-12-09T00:00:00",
      "Maintenance": 643.15, "Structures": 287.36, "Avionics": 150.52, "Inspection": 177.89,
      "Interiors": 109.47, "Engineering": 0, "Cabinet": 0, "Upholstery": 0, "Finish": 0
    },
    {
      "number": "P7430", "customer": "Turkmen", "aircraftModel": "B777", "scope": "Maint/Recon/Refub",
      "induction": "2025-11-10T00:00:00", "delivery": "2026-07-13T00:00:00",
      "Maintenance": 12720.0, "Structures": 12720.0, "Avionics": 3180.0, "Inspection": 3180.0,
      "Interiors": 19080.0, "Engineering": 3180, "Cabinet": 3180, "Upholstery": 3180, "Finish": 3180
    },
    {
      "number": "P7649", "customer": "NEP", "aircraftModel": "B767-300", "scope": "Refurb",
      "induction": "2026-02-02T00:00:00", "delivery": "2026-07-13T00:00:00",
      "Maintenance": 2000.0, "Structures": 2400.0, "Avionics": 2800.0, "Inspection": 800.0,
      "Interiors": 4400.0, "Engineering": 1800, "Cabinet": 1600, "Upholstery": 1200, "Finish": 3000
    },
    {
      "number": "P7689", "customer": "Sands", "aircraftModel": "B737-700", "scope": "C1,C3,C6C7 Mx",
      "induction": "2025-09-10T00:00:00", "delivery": "2026-11-07T00:00:00",
      "Maintenance": 8097.77, "Structures": 1124.69, "Avionics": 899.75, "Inspection": 787.28,
      "Interiors": 337.14, "Engineering": 0, "Cabinet": 0, "Upholstery": 0, "Finish": 0
    },
    {
      "number": "P7690", "customer": "Sands", "aircraftModel": None, "scope": "C1,C2,C7 Mx",
      "induction": "2025-05-25T00:00:00", "delivery": "2025-07-22T00:00:00",
      "Maintenance": 3227.14, "Structures": 2189.85, "Avionics": 922.04, "Inspection": 1152.55,
      "Interiors": 4033.92, "Engineering": 0, "Cabinet": 0, "Upholstery": 0, "Finish": 0
    },
    {
      "number": "P7691", "customer": "Sands", "aircraftModel": "B737-700", "scope": "C1,C2,C3,C7 Mx",
      "induction": "2026-10-13T00:00:00", "delivery": "2026-12-22T00:00:00",
      "Maintenance": 4038.3, "Structures": 5115.18, "Avionics": 1076.88, "Inspection": 1346.1,
      "Interiors": 1884.54, "Engineering": 0, "Cabinet": 0, "Upholstery": 0, "Finish": 0
    }
  ],
  "departments": [
...
if "data_json" not in st.session_state:
    st.session_state["data_json"] = json.dumps(BASE_DATA, indent=2)

with st.sidebar.expander("⚡ Quick edit data (JSON)", expanded=True):
    txt = st.text_area("Paste/modify JSON and click **Load Data**:",
                       st.session_state["data_json"],
                       height=420,
                       label_visibility="collapsed")
    colA, colB = st.columns(2)
    load_clicked = colA.button("Load Data", use_container_width=True, type="primary")
    reset_clicked = colB.button("Reset to Sample", use_container_width=True)
    ...
    if load_clicked:
        try:
            _ = json.loads(txt)  # validate
            st.session_state["data_json"] = txt
            st.experimental_rerun()
        except Exception as e:
            st.error(f"Invalid JSON: {e}")

current_data_json = st.session_state["data_json"]

# ------- Embedded HTML/JS app (we inject the dataset) -------
html_code = r"""
<!DOCTYPE html>
<html>
<head>
  ...
  <style>
    ...
    .row { display:grid; grid-template-columns: 1fr; gap:16px; margin-top:8px; }
    .chart-card {
...
<div class="metric-bar">
  ...
  <div class="metric"><div class="label">Capacity / Period</div><div class="value" id="weeklyCap">—</div></div>
</div>
...
<div class="row">
  ...
  <div class="chart-card">
    ...
    <div class="chart-wrap-small"><canvas id="utilChart"></canvas></div>
  </div>
</div>
...
<div class="modal" id="drilldownModal">
  <header>
    ...
    <button class="closeModal close-btn" id="closeModal">Close</button>
  </header>
  <div class="content">
    <table>
      <thead id="modalHead"><tr><th>Customer / Project</th><th>Hours</th></tr></thead>
...
<script>
/* ===== Injected dataset from Streamlit sidebar ===== */
const defaultData = __DATA_PLACEHOLDER__;

/* ===== State ===== */
let DATA = JSON.parse(JSON.stringify(defaultData));
let PRODUCTIVITY_FACTOR = 0.85;
let HOURS_PER_FTE = 40;
let timelineMode = 'weekly';
...
/* seed inline editor with current dataset */
...
btnLoad.onclick = ()=>{
  try{
    ...
    if(!obj.projects || !obj.potential || !obj.departments) throw new Error("Missing keys (need projects, potential, departments).");
    DATA = obj;
    rebuildEverything();
...
function getWeeklyLabels(){
  ...
  const expand=(arr)=>{ for(const p of arr){ const a=parseDate(p.induction), b=parseDate(p.delivery);
    if(!minD||a<minD) minD=a; if(!maxD||b>maxD) maxD=b; } };
  expand(DATA.projects); expand(DATA.potential);
  if(!minD||!maxD) return [];
  const start=mondayOf(minD), labels=[], cur=new Date(start);
...
function getMonthlyLabels(){
  ...
  expand(DATA.projects); expand(DATA.potential);
  if(!minD||!maxD) return [];
  const start=firstDayOfMonth(minD), end=lastDayOfMonth(maxD), labels=[], cur=new Date(start); cur.setDate(1);
  while(cur<=end){ labels.push(monthKey(cur)); cur.setMonth(cur.getMonth()+1); }
  return labels;
}
...
function workdaysBetween(a,b){
  ...
  while(d<=b){ if(isWorkday(d)) c++; d.setDate(d.getDate()+1); }
  return c;
}
...
function computeLoadsDetailed(arr, key, labels, mode){
  ...
  if(mode==='weekly'){
    ...
    const idxByMonth=new Map(); labels.forEach((mk,i)=>idxByMonth.set(mk,i));
    for(const p of arr){
      const hrs=p[key]||0; if(!hrs) continue;
      const a=parseDate(p.induction), b=parseDate(p.delivery);
      const wd=workdaysBetween(a,b); if(wd===0) continue;
      const perDay=hrs/wd;
      const perMonth=new Map();
      const d=new Date(a);
      while(d<=b){ if(isWorkday(d)){ const mk=monthKey(d); perMonth.set(mk,(perMonth.get(mk)||0)+perDay); } d.setDate(d.getDate()+1); }
      for(const [mk,val] of perMonth.entries()){
        const idx=idxByMonth.get(mk);
        if(idx!=null){ total[idx]+=val; breakdown[idx].push({customer:`${p.customer} (${p.number ?? "N/A"})`, hours:val}); }
      }
    }
  }
...
function capacitySeries(key, labels, mode){
  ...
  if(mode==='weekly') return labels.map(()=>basePerWeek);
  const caps=[];
  for(const mk of labels){
    const [y,m]=mk.split('-').map(Number);
    const start=new Date(y,m-1,1), end=new Date(y,m,0);
    const wd=workdaysBetween(start,end);
    caps.push(basePerWeek*(wd/5));
  }
  return caps;
}

/* Utilization % */
function utilizationArray(confArr, potArr, capArr){
...
/* Today label (weekly) */
function todayLabelWeekly(){ const m=mondayOf(new Date()); return formatDateLocal(m); }
...
/* Global */
let mainChart=null, utilChart=null, currentKey=null, lastClickY=null;

/* Rebuild all */
function rebuildEverything(){ populateDisciplines(); updateVisuals(); }
...
function updateVisuals(){
  ...
  const annos = (timelineMode==='weekly') ? {
    annotations:{ todayLine:{ type:'line', xMin:todayLabelWeekly(), xMax:todayLabelWeekly(),
  ...
  mainChart = new Chart(document.getElementById('mainChart').getContext('2d'),{
    ...
    data:{
      ...
      datasets:[
        { label: ()=> `${(DATA.departments.find(d=>d.Key===currentKey)?.Name)||currentKey} Load (hrs)`,
          data: conf.weeklyTotal, borderColor:brand, backgroundColor:brand20,
        ...
        { label: ()=> `${(DATA.departments.find(d=>d.Key===currentKey)?.Name)||currentKey} Capacity (hrs)`,
          data: cap, borderColor:capacity, backgroundColor:capacity20,
        ...
        { label: ()=> `${(DATA.departments.find(d=>d.Key===currentKey)?.Name)||currentKey} Potential (hrs)`,
          data: pot.weeklyTotal, borderColor:potential, backgroundColor:potential20,
    ...
    options:{
      ...
      scales:{ x:{ title:{display:true, text:labelText} }, y:{ title:{display:true, text:'Hours'}, beginAtZero:true } },
      ...
      onClick:(evt, elems)=>{
        ...
        if(datasetIndex===1) return; // ignore capacity clicks

        const periodTxt = (timelineMode==='weekly' ? `Week ${xLabels[idx]}` : `Month ${xLabels[idx]}`);
        const title = `${periodTxt} · ${ (DATA.departments.find(d=>d.Key===currentKey)?.Name)||currentKey }`;

        if(showPotential){
          const map=new Map();
          (conf.breakdown[idx]||[]).forEach(r=>{ map.set(r.customer,{conf:r.hours,pot:0}); });
          ...
          const rows=Array.from(map.entries()).map(([customer,vals])=>({customer, conf:vals.conf, pot:vals.pot, total:vals.conf+vals.pot}))
  ...
  const utilData = utilizationArray(conf.weeklyTotal, pot.weeklyTotal, cap);
  utilChart = new Chart(document.getElementById('utilChart').getContext('2d'),{
    type:'line',
    data:{ labels:xLabels, datasets:[{
      label:'Utilization %', data:utilData, borderColor:'#374151', backgroundColor:'rgba(55,65,81,0.10)',
      borderWidth:1.8, fill:true, tension:0.1, pointRadius:0
    }]},
    options:{
      responsive:true, maintainAspectRatio:false,
      scales:{ x:{ title:{display:true, text:labelText} }, y:{ title:{display:true, text:'% Utilization'}, beginAtZero:true, suggestedMax:150 } },
      plugins:{ legend:{display:false}, annotation:{ annotations:{ ref100:{ type:'line', yMin:100, yMax:100, borderColor:'#9ca3af', borderWidth:1, borderDash:[6,6],
  ...
  for(let i=0;i<xLabels.length;i++){
    const load = conf.weeklyTotal[i] + (showPotential ? (pot.weeklyTotal[i]||0) : 0);
    const u = cap[i] ? (load/cap[i]*100) : 0;
    if(u>peak){ peak=u; peakIdx=i; }
    const diff = load - cap[i];
    if(diff>worstDiff){ worstDiff=diff; worstIdx=i; }
  }
  const perName = (timelineMode==='weekly') ? 'Week' : 'Month';
  document.getElementById('peakUtil').textContent = `${peak.toFixed(0)}% (${perName} ${xLabels[peakIdx]||'—'})`;
  const status = worstDiff>=0 ? `+${worstDiff.toFixed(0)} hrs over` : `${(-worstDiff).toFixed(0)} hrs under`;
  document.getElementById('worstWeek').textContent = `${perName} ${xLabels[worstIdx]||'—'} · ${status}`;
  document.getElementById('weeklyCap').textContent = `${(cap[0]||0).toFixed(0)} hrs / ${perName.toLowerCase()}`;
}
...
prodSlider.addEventListener('input', e=>{ PRODUCTIVITY_FACTOR=parseFloat(e.target.value||'0.85'); prodVal.textContent=PRODUCTIVITY_FACTOR.toFixed(2); updateVisuals(); });
hoursInput.addEventListener('change', e=>{ const v=parseInt(e.target.value||'40',10); HOURS_PER_FTE=isNaN(v)?40:clamp(v,30,60); e.target.value=HOURS_PER_FTE; updateVisuals(); });

/* Modal anchored to click */
...
function positionModalNearClick(){
  const minPad=16, defaultTop=Math.round(window.innerHeight*0.16);
...
function openModalSingle(title, rows){
  ...
  backdrop.style.display='block'; positionModalNearClick();
}
...
# Inject the current JSON into the HTML safely (no f-strings to avoid brace escaping)
html_code = html_code.replace("__DATA_PLACEHOLDER__", current_data_json)

# Render the HTML app (single scrollbar)
